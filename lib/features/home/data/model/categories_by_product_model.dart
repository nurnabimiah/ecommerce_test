...
CategoriesByProductModel categoriesByProductModelFromJson(String str) => CategoriesByProductModel.fromJson(json.decode(str));

String categoriesByProductModelToJson(CategoriesByProductModel data) => json.encode(data.toJson());
